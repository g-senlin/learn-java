package com.senlin.spring.bean.beanfactorypostprocessor;
 ...
 * @date 2018/9/28 0:08.
 */
public class CacheConfig extends PropertyPlaceholderConfigurer {
     ...
     * @return
     */
    private String resolvePlaceHolder(Properties props,String value) {
        ...
        for ( int pos = 0; pos < chars.length; pos++ ) {
            if ( chars[pos] == '$' ) {
                if ( chars[pos+1] == '{' ) {
                    ...
                    String val = extractFromSystem(props, key);
     ...
     * @return
     */
    private String extractFromSystem(Properties props,String key) {
        try {
